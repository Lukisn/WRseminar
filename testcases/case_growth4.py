...
def main():
    ...
    initial_ndf.to_file("results/growth4_initial_ndf.dat")
    ...
    fp.moments_to_file("results/growth4_fp_moments.dat", max_order=ORDER)
    fp.ndf_to_files("results/growth4_fp_ndf.dat")
    ...
    ca.moments_to_file("results/growth4_ca_moments.dat", max_order=ORDER)
    ca.ndf_to_files("results/growth4_ca_ndf.dat")
    ...
    plt.savefig("results/growth4_ndf.eps")
    plt.show()
    ...
    plt.savefig("results/growth4_mom.eps")
    plt.show()
