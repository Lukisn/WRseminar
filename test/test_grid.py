...
class TestGrid(unittest.TestCase):
    ...
    def test_coarsening_refining(self):
        ...
        self.assertEquals(g.end, 10)
        self.assertEquals(len(g), 9)
        self.assertRaises(AssertionError, g.coarsen, 1, 0)
        self.assertRaises(AssertionError, g.coarsen, -1, 1)
        self.assertRaises(AssertionError, g.coarsen, 1, 99)
        self.assertRaises(AssertionError, g.refine, 1, 0)
        self.assertRaises(AssertionError, g.refine, -1, 1)
        self.assertRaises(AssertionError, g.refine, 1, 99)
